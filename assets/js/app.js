...
let addr;
const sttaddr = "0x6fc6a90becabd125b97de8b1192c7b4584e4b720";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x6fc6a90becabd125b97de8b1192c7b4584e4b720";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://lunarush.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x6fc6a90becabd125b97de8b1192c7b4584e4b720',
                    'symbol': 'LUS',
                    'decimals': '18',
                    'image': 'https://lunarush.net/images/logo.png',
                },
            },
